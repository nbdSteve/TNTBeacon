package gg.steve.mc.baseball.tntb.framework.utils.actionbarapi;
...
public class ActionBarAPI {
    ...
    public static void sendActionBar(final Player player, final String message, int duration, JavaPlugin instance) {
    ...
    public static void sendActionBarToAllPlayers(String message, JavaPlugin instance) {
        sendActionBarToAllPlayers(message, -1, instance);
    }

    public static void sendActionBarToAllPlayers(String message, int duration, JavaPlugin instance) {
        for (Player p : Bukkit.getOnlinePlayers()) {
            sendActionBar(p, message, duration, instance);
        }
    }
}
